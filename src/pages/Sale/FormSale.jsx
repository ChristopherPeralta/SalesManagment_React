...
function FormSale() { 
    ...
    const handleSaveSale = () => { 
        ...
        createSale(saleData) // Cambiar a createSale
            .then(response => {
                console.log("Response from createSale:", response.data); 
    ...
    return (
        <div>
            ...
            <InputField
                type="number"
                name="price"
                label="Precio Venta" // Cambiar a Precio Venta
                value={price}
            ...
            <button 
                onClick={handleSaveSale} // Cambiar a handleSaveSale
            ...
            <button onClick={handleSaveSale} className="px-4 py-2 font-bold text-white bg-blue-500 rounded hover:bg-blue-700 mt-4">
                Guardar Venta
            </button>
        </div>
    );
